...
class InspectionDetailScreen extends StatelessWidget {
  ...
  Future<void> _openDecisionDialog(BuildContext context) async {
    ...
    final saved = await showDialog<bool>(
      context: context,
      builder: (_) =>
          DecisionDialog(inspectionId: inspectionId, inspection: inspection),
    );
    if (saved == true) {
      await cubit.load();
      if (context.mounted) {
              ...
              builder: (context, constraints) {
                ...
                final actions = <Widget>[
                  ...
                  AppButton(
                    ...
                    onPressed: state.busy.isEmpty
                        ? () => _exportPdf(context, 'report')
                        : null,
                  ),
                  AppButton(
                    style: AppButtonStyle.secondary,
            ...
            Wrap(
              ...
              children: [
                AppButton(
                  ...
                  onPressed: (user?.canEditInspections ?? false)
                      ? () => _openDecisionDialog(context)
                      : null,
                ),
          ...
          children: [
            ...
            Table(
              ...
              children: [
                ...
                for (final param in params) TableRow(children: _rowFor(param)),
              ],
            ),
          ],
        ),
